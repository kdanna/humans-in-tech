...
// Send form data to google sheets - DEPRECATED FOR NOW. CANNOT USE ENV VARS IN STATIC HOSTING 
class SignUp extends Component {
    ...
    handleSubmit = () => {
        if (!IsValidEmail(this.state.emailAddress)){
            ...
            const urlBase = process.env.NODE_ENV === 'production' ? 'http://localhost:3000' : process.env.REACT_APP_GOOGLE_SHEETS_API_URL;

            // const urlBase = process.env.REACT_APP_GOOGLE_SHEETS_API_URL
            console.log(urlBase)
